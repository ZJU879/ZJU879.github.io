...
int send2server(char *webaddr,int device_id,char senddata[][20]);//public  return:0 success;-1 failed
int receive4server(char *webaddr,int device_id,char *ret_msg);//public	return:0 have message in ret_msg; -1 no message returned
