...
int report_packet(int *psocket_id,char* host_addr,char* host_file,int host_port,int device_id,int report_id,char data[][10]){//上传数据包到服务器，返回response信息
...
int send2server(char *webaddr,int device_id,int report_id,char senddata[][10]){
/* 获取输入参数 */
